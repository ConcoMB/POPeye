...
public class Brutus extends Service {
	...
	enum BrutusVariable {
		MINHOUR, MAXHOUR, QUANT, SERVER, ERASE_DATE, ERASE_FROM, ERASE_CONTENTTYPE, ERASE_MINSIZE, 
		ERASE_MAXSIZE, ERASE_ATTACHMENT, ERASE_HEADER, ERASE_PICTURE, BLOCK_IP, ANONYMOUS_T, VOWELS_T, 
		IMAGE_T, ADD_APP, DEL_APP;
	}
